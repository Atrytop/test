...
(function(Aa, Y) {
    ...
    function B() {
        var a, b = arguments, c, d = {}, e = function(a, b) {
            ...
            for (d in b)
                ...
                a[d] = c && typeof c === "object" && Object.prototype.toString.call(c) !== 
        ...
        for (var c = "{", d = !1, e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                if (f.length)
                    ...
                    e !== null  && (e = u.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Pa(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
            ...
            init: function(b) {
                ...
                a.each(["cur", "_default", "width", "height", "opacity"], function(b, e) {
                    ...
                    (g = f[e]) && (f[e] = function(a) {
                        ...
                        if (f.prop !== "align")
                            return c = f.elem,
                            c.attr ? c.attr(f.prop.replace("strokeWidth", "stroke-width"), e === "cur" ? void 0 : f.now) : 
    ...
    function Db() {
        ...
        lb = function(a, c, d, h, i, k) {
            var j;
            b ? (j = xa.UTC.apply(0, arguments),
            j += Ya(j)) : j = (new xa(a,c,p(d, 1),p(h, 0),p(i, 0),p(k, 0))).getTime();
            return j
        }
        ;
        tb = c + "Minutes";
    ...
    ea.prototype = {
        ...
        init: function(a) {
            ...
            if ((this.input = a) && a.stops)
                this.stops = Ma(a.stops, function(a) {
                    return new ea(a[1])
                });
            else
    ...
    M.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                for (s in j)
                    r.push(j[s]);
                r = r.join(",");
                i[r] ? n = i[r].attr("id") : (g.id = n = "highcharts-" + zb++,
                i[r] = k = d.createElement(f).attr(g).add(d.defs),
                k.radAttr = 
                h,
                k.stops = [],
                o(j, function(a) {
                    a[1].indexOf("rgba") === 0 ? (e = ea(a[1]),
                    l = e.get("rgb"),
                    m = e.get("a")) : (l = a[1],
                    m = 1);
        ...
        updateShadows: function(a, b) {
            for (var c = this.shadows, d = c.length; d--; )
                c[d].setAttribute(a, a === "height" ? Math.max(b - (c[d].cutHeight || 0), 0) : a === "d" ? this.d : b)
        },
        addClass: function(a) {
            var b = this.element
              , c = O(b, "class") || "";
        ...
        getBBox: function(a, b) {
            ...
            f = p(b, this.rotation);
            g = f * ha;
            e !== x && (s = ["", f || 0, i && i.fontSize, h.style.width].join(","),
            s = e === "" || Rb.test(e) ? "num:" + e.toString().length + s : e + s);
            s && !a && (c = m[s]);
            if (!c) {
                if (h.namespaceURI === Ea || d.forExport) {
                    try {
                        ...
                        ,
                        La && j.textShadow ? (k = j.textShadow,
                        j.textShadow = "") : l && l("none"),
                        c = h.getBBox ? t({}, h.getBBox()) : {
                            width: h.offsetWidth,
                ...
                if (d.isSVG) {
                    d = c.width;
                    e = c.height;
                    if (sa && i && i.fontSize === "11px" && e.toPrecision(3) === "16.9")
                        c.height = 
                        e = 14;
                    if (f)
                        c.width = P(e * aa(g)) + P(d * T(g)),
    ...
    za.prototype = {
        ...
        buildText: function(a) {
            ...
            ; r--; )
                b.removeChild(g[r]);
            !f && !n && !s && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(w(e))) : (h = /<.*style="([^"]+)".*>/,
            i = /<.*href="(http[^"]+)".*>/,
            X && X.appendChild(b),
            e = f ? e.replace(/<(b|strong)>/g, 
            '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e],
            e[e.length - 1] === "" && e.pop(),
            o(e, function(e, f) {
                ...
                o(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        O(r, "style", p));
                        i.test(e) && !d && 
                        (O(r, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                        J(r, {
                            cursor: "pointer"
                        }));
                        e = w(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            O(r, "dy", z(r)));
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), X = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, D, q, v = [], x = z(r), t = 1, y = a.rotation, u = e, B = u.length; (X || s) && (n.length || v.length); )
                                    a.rotation = 0,
                                    o = a.getBBox(!0),
                                    q = o.width,
                                    !Z && c.forExport && (q = c.measureSpanWidth(r.firstChild.data, a.styles)),
                                    o = q > l,
                                    D === void 0 && (D = o),
                                    s && D ? (B /= 2,
                                    u === "" || !o && B < 0.5 ? n = [] : (o && (D = !0),
                                    u = e.substring(0, u.length + (o ? -1 : 1) * ta(B)),
                                    n = [u + (l > 3 ? "\u2026" : "")],
                                    r.removeChild(r.firstChild))) : !o || n.length === 1 ? (n = v,
                                    v = [],
                                    n.length && (t++,
                                    ...
                                    p && O(r, "style", p),
                                    b.appendChild(r)),
                                    q > l && (l = q)) : (r.removeChild(r.firstChild),
                                    v.unshift(n.pop())),
                                    n.length && r.appendChild(C.createTextNode(n.join(" ").replace(/- /g, "-")));
                                D && a.attr("title", 
                                a.textStr);
                                a.rotation = y
                            }
        ...
        b, c, d, e, f) {
            ...
            if (h)
                ...
                ,
                k = a.match(i)[1],
                a = Kb[k] || f && f.width && f.height && [f.width, f.height],
                g = this.image(k).attr({
                    x: b,
                    y: c
                }),
        ...
        b) {
            ...
            !a && b && K.getComputedStyle && (b = b.element || b,
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            var k = this, j = k.g(i), l = k.text("", 0, 0, g).attr({
                zIndex: 1
            }), m, n, s = 0, r = 3, p = 0, z, w, D, v, ca = 0, hb = {}, u, E, I, C, A;
            I = function() {
                var a, b;
                a = l.element.style;
                n = (z === void 0 || 
                ...
                if (E) {
                    if (!m)
                        a = ca,
                        b = (h ? -u : 0) + ca,
                        j.box = m = d ? k.symbol(d, a, b, j.width, j.height, hb) : k.rect(a, b, j.width, j.height, 0, hb["stroke-width"]),
    ...
    t(M.prototype, {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {}
              , e = sa ? "-ms-transform" : nb ? "-webkit-transform" : La ? "MozTransform" : Jb ? "-o-transform" : "";
    ...
    if (!Z && !ia) {
        ...
        var Na = {
            ...
            b, c, d) {
                var e;
                this.alignedObjects = [];
                d = this.createElement(Ka).css(t(this.getStyle(d), {
                    position: "relative"
                }));
                e = d.element;
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            ...
                            n = m.x2 || m[2] || 0,
                            m = m.y2 || m[3] || 0,
                            w = 'angle="' + (90 - U.atan((m - a) / (n - c)) * 180 / na) + '"',
                            ca();
                        else {
                            var k = m.r, v = k * 2, u = k * 2, x = m.cx, t = m.cy, y = b.radialReference, B, k = function() {
                                y && (B = 
                                d.getBBox(),
                                x += (y[0] - B.x) / B.width - 0.5,
                                t += (y[1] - B.y) / B.height - 0.5,
                                v *= y[2] / B.width,
                                u *= y[2] / B.height);
    ...
    Va.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? ga(ka(e)) : e
            });
            q(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(B(g.style)).add(a.labelGroup) : null ) && d.getBBox().width,
            this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            ...
            if (h)
                h < 0 && c - i * k < f ? m = y(c / T(h * ha) - f) : h > 0 && c + i * k > e && (m = y((d - c) / T(h * ha)));
            else if (d = c + (1 - i) * k,
            c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i,
            l = -1),
            j = E(b.slotWidth, j),
            j < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - j - i * (b.slotWidth - E(k, j)))),
        ...
        render: function(a, b, c) {
            ...
            "Length"]
              ...
              , ca = !0
              , v = d.tickmarkOffset
              , u = this.getPosition(g, k, v, b)
              , t = u.x
              , u = u.y
              , y = g && t === d.pos + d.len || !g && u === d.pos ? -1 : 1
              , c = p(c, 1);
            this.isActive = !0;
            if (s) {
            ...
            if (m && z)
                ...
                (z = -z),
                d.opposite && (z = -z),
                h = this.getMarkPath(t, u, z, m * y, g, f),
                n ? n.animate({
                    d: h,
                    opacity: c
            ...
            if (i && !isNaN(t))
                i.xy = u = this.getLabelPosition(t, u, i, g, j, v, a, q),
                this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? ca = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(u),
                q && a % q && (ca = !1),
                ca && !isNaN(u.y) ? (u.opacity = c,
    ...
    u.PlotLineOrBand.prototype = {
        render: function() {
            ...
            else if (n && n.length && (a.svgElem = m = D.path(n).attr(w).add(),
            o))
    ...
    ja.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: B(ba.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        init: function(a, b) {
            ...
            Fa(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        d.length)
                            ...
                            a.dataMax = v(p(a.dataMax, d[0]), Da(d))
                    } else {
                        c.getExtremes();
                        f = c.dataMax;
                        c = c.dataMin;
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            f === "between" && (f = 0.5),
            a = h * (a - d) * k + i + h * j + (qa(f) ? k * f * g.pointRange : 0));
            return a
        },
        ...
        setAxisTranslation: function(a) {
            ...
            if (j || i || d)
                ...
                o(b.series, function(a) {
                    ...
                    e, 0) : b.axisPointRange || 0
                      , a = a.options.pointPlacement;
                    d = v(d, c);
                    b.single || (f = v(f, Ba(a) ? 0 : c / 2),
                    g = v(g, a === "on" ? 0 : c))
                })),
        ...
        setTickInterval: function(a) {
            ...
            d.type !== b.linkedParent.options.type && Y(11, 1)) : (!s && q(n) && (b.dataMin >= n ? (r = n,
            k = 0) : b.dataMax <= n && (X = n,
            i = 0)),
            b.min = p(z, r, b.dataMin),
            b.max = p(w, X, b.dataMax));
            if (e)
                !a && 
                E(b.min, p(b.dataMin, b.min)) <= 0 && Y(10, 1),
                b.min = ga(Ca(b.min), 15),
                b.max = ga(Ca(b.max), 15);
            if (b.range && q(b.max))
                b.userMin = b.min = z = v(b.min, b.minFromRange()),
                b.userMax = w = b.max,
                b.range = null ;
            ...
            if (s && q(b.dataMin))
                if (n = n || 0,
                !q(z) && b.min < n && b.dataMin >= 
                n)
                    b.min = n;
                else if (!q(w) && b.max > n && b.dataMax <= n)
                    b.max = n;
            ...
            if (!j && b.tickInterval < a)
                b.tickInterval = a;
            if (!f && !e && !j)
                b.tickInterval = sb(b.tickInterval, null , rb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function() {
            ...
            this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max),
            ...
            !j)) {
                ...
                for (n = c.length; !f && n--; )
                    ...
                    i = d[s].label)
                        ...
                        i.getBBox().height > this.len / c.length - (h.h - h.f) || d[s].labelLength > g)
                            i.specCss = {
        ...
        getOffset: function() {
            ...
            if (s && s.text && s.enabled !== !1) {
                if (!a.axisTitle)
                    a.axisTitle = c.text(s.text, 0, 0, s.useHTML).attr({
                        zIndex: 7,
        ...
        render: function() {
            ...
            if (a.hasData() || f) {
                ...
                m && o(g, function(c, d) {
                    ...
                    if (d % 2 === 0 && c < a.max && v <= a.max + (b.polar ? -n : n))
                        j[c] || (j[c] = new u.PlotLineOrBand(a)),
                        D = c + n,
                        j[c].options = {
                            from: e ? ka(D) : D,
                            to: e ? ka(v) : v,
        ...
        drawCrosshair: function(a, b) {
            ...
            if (!this.crosshair || (q(b) || !p(d.snap, !0)) === 
            !1 || b && b.series && b.series[this.coll] !== this)
                this.hideCrosshair();
    ...
    ja.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (k >= F.second)
                i[Fb](k >= F.minute ? 0 : j * S(i.getSeconds() / j));
            if (k >= F.minute)
                i[Gb](k >= F.hour ? 0 : j * S(i[tb]() / j));
            if (k >= F.hour)
                i[Hb](k >= F.day ? 0 : j * S(i[ub]() / j));
            if (k >= F.day)
                i[wb](k >= F.month ? 1 : j * S(i[Za]() / j));
            k >= F.month && (i[xb](k >= F.year ? 0 : j * S(i[$a]() / j)),
            h = i[ab]());
            k >= F.year && (h -= h % j,
            i[yb](h));
            if (k === F.week)
            ...
            if (qb || ib)
                ...
                i = new xa(i + Ya(i));
            h = i[ab]();
            for (var d = i.getTime(), l = i[$a](), m = i[Za](), n = (F.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % F.day; d < c; )
                e.push(d),
                k === F.year ? d = lb(h + b * j, 0) : k === F.month ? d = lb(h, l + b * j) : !g && (k === F.day || k === F.week) ? d = lb(h, l, m + b * j * (k === F.day ? 1 : 7)) : d += k * j,
                b++;
            e.push(d);
            o(fb(e, function(a) {
    ...
    ja.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        a = p(a === "auto" ? null  : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : 
        f) || 1)),
        a = sb(a, null , rb(a)),
        g = Ma(this.getLinearTickPositions(a, b, c), Ca),
        !d)
    ...
    Ob.prototype = {
        ...
        getAnchor: function(a, b) {
            ...
            c = [b.chartX - d.plotLeft, b.chartY - 
            f]);
            c || (o(a, function(a) {
                k = a.series.yAxis;
                j = a.series.xAxis;
        ...
        refresh: function(a, b) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (Wa(d),
    ...
    Xa.prototype = {
        ...
        normalize: function(a, b) {
            ...
            d.pageX === x ? (c = v(a.x, a.clientX - b.left),
            d = a.y) : (c = d.pageX - 
            b.left,
            d = d.pageY - b.top);
            return t(a, {
        ...
        drag: function(a) {
            ...
            if (!m || !m.touch)
                ...
                e < i ? e = i : e > i + j && (e = i + j),
                this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(s - e, 2)),
                this.hasDragged > 10) {
                    l = b.isInsidePlot(n - h, s - i);
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !r && 
                    !m)
        ...
        onContainerClick: function(a) {
            var b = this.chart
              ...
              , a = this.normalize(a);
            a.originalEvent = a;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (G(c.series, "click", t(a, {
                point: c
            })),
            b.hoverPoint && c.firePointEvent("click", a)) : (t(a, this.getCoordinates(a)),
            b.isInsidePlot(a.chartX - 
        ...
        destroy: function() {
            ...
            db || (W(C, "mouseup", this.onDocumentMouseUp),
            W(C, "touchend", this.onDocumentTouchEnd));
    ...
    pb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!o) {
                ...
                if (!this.baseline)
                    this.fontMetrics = 
                    c.fontMetrics(h.fontSize, o),
                    this.baseline = this.fontMetrics.f + 3 + s,
            ...
            if (e && this.itemX - r + f > (m || b.chartWidth - 2 * k - r - d.x))
                this.itemX = r,
            ...
            e ? this.itemX += f : (this.itemY += s + g + n,
        ...
        handleOverflow: function(a) {
            ...
            c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, k = e.navigation, j = p(k.animation, !0), l = k.arrowSize || 12, m = this.nav, n = this.pages, s = this.padding, r, q = this.allItems, z = function(a) {
                ...
                if (b.contentGroup.div)
                    b.contentGroup.div.style.clip = "rect(" + s + "px,9999px," + (s + a) + "px,0)"
            }
            ;
            ...
            if (a > f) {
                ...
                if (!i)
                    i = b.clipRect = d.clipRect(0, s, 9999, 0),
    ...
    Q.prototype = {
        ...
        getChartSize: function() {
            ...
            if (!q(b))
                this.containerWidth = eb(c, "width");
            if (!q(a))
                this.containerHeight = eb(c, "height");
        ...
        drawChartBox: function() {
            ...
            if (j)
                f ? f.animate(w) : this.plotBackground = b.rect(p, o, q, z, 0).attr({
                    fill: j
                }).add().shadow(a.plotShadow);
            if (l)
                h ? h.animate(w) : this.plotBGImage = b.image(l, p, o, q, z).add();
            v ? v.animate({
                width: u.width,
                height: u.height
    ...
    R.prototype = {
        ...
        autoIncrement: function() {
            ...
            d === "year")
                a = new xa(b),
                a = d === "month" ? +a[xb](a[$a]() + c) : +a[yb](a[ab]() + c),
                c = a - b;
            this.xIncrement = b + c;
            return b
        },
        ...
        processData: function(a) {
            ...
            if (h)
                ...
                m = a.max;
            if (j && 
            this.sorted && !k && (!i || d > i || this.forceCrop))
                if (b[d - 1] < l || b[0] > m)
                    b = [],
                    c = [];
            ...
            for (i = b.length - 1; i >= 0; i--)
                d = b[i] - b[i - 1],
                d > 0 && (g === x || d < g) ? g = d : d < 0 && this.requireSorting && Y(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++)
                i = h + m,
                k ? l[m] = (new f).init(this, [d[m]].concat(ra(e[m]))) : (b[i] ? j = b[i] : a[i] !== x && (b[i] = j = (new f).init(this, a[i], d[m])),
                l[m] = j),
                l[m].index = i;
            if (b && (g !== (c = b.length) || 
            k))
        ...
        getExtremes: function(a) {
            ...
            for (l = 0; l < d; l++)
                if (k = c[l],
                j = a[l],
                i = j !== null  && j !== x && (!b.isLog || j.length || j > 0),
        ...
        translate: function() {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === "between" || qa(i), j = a.threshold, l = a.startFromThreshold ? j : 0, m, n, s, o, u = Number.MAX_VALUE, a = 0; a < g; a++) {
                ...
                if (b && this.visible && t && t[w])
                    ...
                    n === l && (n = p(j, e.min)),
                    e.isLog && n <= 0 && (n = null ),
                    z.total = z.stackTotal = t.total,
                    z.percentage = t.total && z.y / t.total * 100,
                    z.stackY = D,
                ...
                for (f = b.length; f--; )
                    ...
                    a && e !== x && !isNaN(e) && g.y !== null )
                        ...
                        j)
                            ...
                            if (o && (h > 0 || k))
                                g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, s ? n : l).attr(a).add(q)
                        }
                    else if (j)
                        g.graphic = j.destroy()
        },
        ...
        getAttribs: function() {
            ...
            e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || ea(e.color || g).brighten(e.brightness).get(),
                ...
                for (; g--; ) {
                    ...
                    if (k) {
                        ...
                        if (!b.marker || j.negative && !f.fillColor && !e.fillColor)
                            f[a.pointAttrToOptions.fill] = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || ea(j.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: j.color
                        };
                        if (!s)
        ...
        destroy: function() {
            ...
            for (g in a)
                a[g] instanceof M && !a[g].survive && (d = c && g === "group" ? "hide" : "destroy",
                a[g][d]());
            if (b.hoverSeries === a)
                b.hoverSeries = null ;
            la(b.series, a);
        ...
        searchKDTree: function(a, b) {
            function c(a, b, k, j) {
                ...
                b[n] && (n = c(a, b[n], k + 1, j),
                o = n[g] < o[g] ? n : l);
                b[p] && Math.sqrt(m * m) < o[g] && (a = c(a, b[p], k + 1, j),
                o = a[g] < o[g] ? a : o);
                return o
            }
            var d = this
    ...
    Ib.prototype = {
        ...
        setOffset: function(a, b) {
            var c = this.axis
              ...
              , g = c.translate(c.usePercentage ? 100 : 
            this.total, 0, 0, 0, 1)
              , c = c.translate(0)
              , c = P(g - c)
    ...
    R.prototype.setStackedPoints = function() {
        ...
        !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (w = 0; w < d; w++) {
                ...
                e === "percent" ? (r = r ? i : k,
                j && m[r] && m[r][t] ? (r = m[r][t],
                q.total = r.total = v(r.total, q.total) + P(y) || 0) : q.total = ga(q.total + (P(y) || 0))) : q.total = ga(q.total + (y || 0));
                q.cum = p(q.cum, g) + (y || 0);
                    ...
                    if (!l || h[b] && h[b].y !== null )
                        if (h[b])
                            ...
                            for (n = a.index; n <= f.series.length; n++)
                                if (m = a.getStackIndicator(null , b, n),
                                j = g[b].points[m.key]) {
                                    d = j[1];
                                    break
                                }
    ...
    wa = ma(R, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                j += l;
                i > a && i > e ? (i = v(a, e),
                j = 2 * e - i) : i < a && i < e && (i = E(a, e),
                j = 2 * e - i);
                j > g && j > e ? (j = v(g, e),
                i = 2 * e - j) : j < g && j < e && (j = E(g, e),
                i = 2 * e - j);
                b.rightContX = k;
                b.rightContY = j
            }
    ...
    wa = ma(R, {
        ...
        getColumnMetrics: function() {
            ...
            var k = E(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len)
              , j = k * b.groupPadding
              , l = (k - 2 * j) / i
        ...
        drawPoints: function() {
            ...
            o(a.points, function(h) {
                ...
                if (i !== x && !isNaN(i) && h.y !== null )
                    ...
                    k ? (Wa(k),
                    k.attr(i).attr(g)[b.pointCount < e ? "animate" : "attr"](B(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, 
        ...
        animate: function(a) {
            ...
            if (Z)
                a ? (e.scaleY = 0.001,
                a = E(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))),
        ...
        drawPoints: function() {
            ...
            function(k) {
                if (k.y !== null ) {
                    ...
                    f && f.attr(c);
                    if (d)
                        d.setRadialReference(a.center).attr(g).animate(t(h, c));
                    else {
                        i = {
                            "stroke-linejoin": "round"
                        };
    ...
    R.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels)
            ...
            k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", 
            d.zIndex || 6),
            p(d.defer, !0) && (k.attr({
                opacity: +h
            }),
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart
          ...
          , l = this.visible && (a.series.forceDL || f.isInsidePlot(h, y(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (l)
            d = t({
                x: g ? f.plotWidth - i : h,
            ...
            c.rotation ? (a = f.renderer.rotCorr(j, c.rotation),
            b[e ? "attr" : "animate"]({
                x: d.x + 
                c.x + d.width / 2 + a.x,
            ...
            g = b.alignAttr,
            p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)),
            c.shape && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
    ...
    if (N.pie)
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (J = 2; J--; ) {
                    ...
                    if (M) {
                        ...
                        for (I = b = 0; !b && K[I]; )
                            b = K[I] && K[I].dataLabel && (K[I].dataLabel.getBBox().height || 21),
                            I++;
                        if (m > 0) {
                            w = E(r + q + m, d.plotHeight);
                            for (I = v(0, r - q - m); I <= w; I += b)
                                H.push(I);
                            w = H.length;
                            if (M > w) {
                                c = [].concat(K);
                            ...
                            for (I = 0; I < M; I++) {
                                ...
                                if (L < I && H[I] !== null )
                                    ...
                                    for (w < M - I + L && H[I] !== null  && (L = w - M + I); H[L] === null ; )
                                        L++;
                                O.push({
                                    i: L,
                                    y: H[L]
                        ...
                        for (I = 0; I < M; I++) {
                            ...
                            if (this.options.size === null )
                                w = t.width,
                                C - w < f ? G[3] = v(y(w - C + f), G[3]) : C + w > h - f && (G[1] = v(y(C + w - h + f), G[1])),
                                A - b / 2 < 0 ? G[0] = v(y(-A + b / 2), G[0]) : A + b / 2 > i && (G[2] = v(y(A + b / 2 - i), G[2]))
                        }
                    }
                }
                if (Da(G) === 0 || this.verifyDataLabelOverflow(G))
                    ...
                    u && g && o(this.points, function(b) {
                        ...
                        if ((t = b.dataLabel) && t._pos && b.visible)
                            ...
                            C = t.connX,
                            A = t.connY,
                            j = l ? ["M", C + (x[6] === "left" ? 5 : -5), A, "C", C, A, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", C + (x[6] === "left" ? 5 : -5), A, "L", x[2], x[3], "L", x[4], x[5]],
                            k ? (k.animate({
                                d: j
                            }),
                            k.attr("visibility", F)) : b.connector = k = a.chart.renderer.path(j).attr({
                                "stroke-width": g,
        ...
        N.pie.prototype.verifyDataLabelOverflow = function(a) {
            ...
            d[0] !== null  ? f = v(b[2] - v(a[1], a[3]), e) : (f = v(b[2] - a[1] - a[3], e),
            b[0] += (a[3] - a[1]) / 2);
            d[1] !== null  ? f = v(E(f, b[2] - v(a[0], a[2])), e) : (f = v(E(f, b[2] - a[0] - a[2]), e),
            b[1] += (a[0] - a[2]) / 2);
            f < b[2] ? (b[2] = f,
            b[3] = Math.min(/%$/.test(c.innerSize || 
            0) ? f * parseFloat(c.innerSize || 0) / 100 : parseFloat(c.innerSize || 0), f),
            this.translate(b),
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (e = 0; e < b; e++) {
                ...
                for (d = e + 1; d < b; ++d)
                    ...
                    m = j.alignAttr,
                    n = 2 * (k.box ? 0 : k.padding),
                    l = !(m.x > l.x + (k.width - n) || m.x + (j.width - n) < l.x || m.y > l.y + (k.height - n) || m.y + (j.height - n) < l.y)))
    ...
    if (N.column)
        wa.prototype.drawTracker = fa.drawTrackerPoint;
    if (N.pie)
        N.pie.prototype.drawTracker = 
        fa.drawTrackerPoint;
    if (N.scatter)
        pa.prototype.drawTracker = fa.drawTrackerPoint;
    t(pb.prototype, {
    ...
    t(Q.prototype, {
        ...
        pan: function(a, b) {
            ...
            o(b === "xy" ? [1, 0] : [1], function(b) {
                ...
                (!i || k < v(j.dataMax, j.max)))
                    h.setExtremes(l, k, !1, !1, {
                        trigger: "pan"
                    }),
                    e = !0;
            ...
            a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)
                    ...
                    if (a && i)
                        ...
                        j)
                            ...
                            j.currentSymbol = l;
                    if (j)
                        j[a && m.isInsidePlot(c, 
                        d, m.inverted) ? "show" : "hide"](),
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    n.attr(t(Z ? {
                        ...
                        fill: ea(this.color || e.color).setOpacity(c.opacity).get()
